...
define(['js/PanelBase/PanelBase',
    ...
    'js/Widgets/DrawerOpenWidget/DrawerOpenWidget',
    ...
    FooterControlsPanel.prototype.createCredits = function (navBarInner) {
        ...
        pullLeft.append($('<div class="navbar-text"><div class="webgme-copyright">&copy; 2018 <a href="http://www.isis.vanderbilt.edu/" title="Vanderbilt University" target="_blank">Vanderbilt University</a></div></div>'));
    ...
    FooterControlsPanel.prototype.createWidgets = function (navBarInner) {
        ...
        this._widgets.push(new DrawerOpenWidget(drawerOpenEl, this._client));
