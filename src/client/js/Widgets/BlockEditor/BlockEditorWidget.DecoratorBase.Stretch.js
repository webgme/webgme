...
define(['js/Widgets/BlockEditor/BlockEditorWidget.Constants'], function (SNAP_CONSTANTS) {
     ...
     * @param {Object} shift
     */
    SVGDecoratorBlockEditorWidgetStretch.prototype._shiftCustomConnectionHighlightAreas =
        function (ptr, role, axis, shift) {
     ...
     * @return {undefined}
     */
    SVGDecoratorBlockEditorWidgetStretch.prototype._stretchCustomConnectionHighlightAreas =
        function (stretchClass, stretch) {
            if (this[SNAP_CONSTANTS.CONNECTION_HIGHLIGHT]) {
    ...
    SVGDecoratorBlockEditorWidgetStretch.prototype.stretch = function (id, axis, delta, type) {
        ...
        if (type === SNAP_CONSTANTS.STRETCH_TYPE.TEXT) {//add the svg elements
            stretchElements = stretchElements.concat(
                this.stretchElementsByPointer[id][SNAP_CONSTANTS.STRETCH_TYPE.SVG][axis]);
        }
