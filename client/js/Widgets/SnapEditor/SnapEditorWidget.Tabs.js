...
define(['js/Toolbar/ToolbarButton',
    ...
    SnapEditorWidgetTabs = function () {
    };

    SnapEditorWidgetTabs.prototype._initializeTabs = function () {
        var self = this;
    ...
    SnapEditorWidgetTabs.prototype._addTabsButtonEnabled = function (enabled) {
        if (this.$btnAddTab) {
            this.$btnAddTab.enabled(enabled);
        }
    };

    SnapEditorWidgetTabs.prototype.clearTabs = function () {
    ...
    SnapEditorWidgetTabs.prototype._makeTabsSortable = function () {
        var self = this;
    ...
    SnapEditorWidgetTabs.prototype._destroyTabsSortable = function () {
        if (this.$ulTabTab && this.$ulTabTab.hasClass('ui-sortable')) {
            this.$ulTabTab.sortable('destroy');
        }
    };

    SnapEditorWidgetTabs.prototype.addTab = function (title, deletable, renamable) {
        var self = this;
    ...
    SnapEditorWidgetTabs.prototype.addMultipleTabsBegin = function () {
        this._addingMultipleTabs = true;

        this.$ulTabTab.hide();
    };

    SnapEditorWidgetTabs.prototype.addMultipleTabsEnd = function () {
        this.$ulTabTab.show();
    ...
    SnapEditorWidgetTabs.prototype._tabsScrollLeft = function () {
        if (this._tabScrollValue < 0) {
            this._scrollTabListBy(Math.min(Math.abs(this._tabScrollValue), TAB_SCROLL));
        }
    };

    SnapEditorWidgetTabs.prototype._tabsScrollRight = function () {
    ...
    SnapEditorWidgetTabs.prototype._scrollTabListBy = function (value) {
    ...
    SnapEditorWidgetTabs.prototype.selectTab = function (tabID) {
        var liToSelect,
    ...
    SnapEditorWidgetTabs.prototype._scrollSelectedTabIntoView = function () {
    ...
    SnapEditorWidgetTabs.prototype._refreshTabScrollButtons = function () {
        var overflowRightBy = this.$ulTabTab.width() - this.$tabsContainer.width() + this.$divAddTab.outerWidth(true) + this._tabScrollValue;
    ...
    SnapEditorWidgetTabs.prototype._onTabsSortStop = function () {
    ...
    SnapEditorWidgetTabs.prototype._refreshTabTabsScrollOnResize = function () {
    ...
    SnapEditorWidgetTabs.prototype.onTabDeleteClicked = function (tabID) {
        this.logger.warning('onTabDeleteClicked not implemented: "' + tabID + '"');
    };

    SnapEditorWidgetTabs.prototype.onTabAddClicked = function () {
        var tabID = this.addTab('New tab', true);
        this.logger.warning('onTabAddClicked not implemented: "' + tabID + '"');
    };

    SnapEditorWidgetTabs.prototype.onTabTitleChanged = function (tabID, oldValue, newValue) {
        this.logger.warning('onTabTitleChanged not implemented: ID: ' + tabID + ' "' + oldValue + '" --> "' + newValue + '"');
    };

    SnapEditorWidgetTabs.prototype.onSelectedTabChanged = function (tabID) {
        this.logger.warning('onSelectedTabChanged not implemented: "' + tabID + '"');
    };

    SnapEditorWidgetTabs.prototype.onTabsSorted = function (newTabIDOrder) {
        this.logger.warning('onTabsSorted not implemented: "' + newTabIDOrder + '"');
    };

    return SnapEditorWidgetTabs;
});
