...
define(['clientUtil',
        'logManager',
        'js/Constants',
        'lib/jquery/jquery.dynatree.min',
        'lib/jquery/jquery.contextMenu',
        'css!/css/DynaTreeBrowserWidget'], function (util, logManager, CONSTANTS) {

    var DynaTreeBrowserWidget = function (containerEl) {
        var logger,
        ...
        //save parent control
        this.containerControl =  containerEl;

        //clear container content
        this.containerControl.html("");

        //generate unique id for control
        this.guid = 'sdlfkjhsdkljghsdljkghslkdghksdghksdlghksdlghkdlsjghkdhgahiweoutö4823975ö34';
        ...
        //Context menu OPEN option
        var contextMenuOpen = $('<li/>', {
            "class" : "openVis separator"
        }).html("<a href='#openVis'>Open in visualizer</a>");
        myContextMenu.append(contextMenuOpen);

        //Context menu OPEN option
        var contextMenuAddChild = $('<li/>', {
            "class" : "create separator"
        }).html("<a href='#createNode'>Create</a>");
        myContextMenu.append(contextMenuAddChild);

        //Context menu EDIT option
        contextMenuEdit = $('<li/>', {
            "class" : "edit"
        }).html("<a href='#edit'>Rename</a>");
        ...
        var createNode = function (nodeToEdit) {
            ...
            logger.debug("Create child for " + nodeToEdit.data.key);
            if ($.isFunction(self.onNodeCreate)) {
                self.onNodeCreate.call(self, nodeToEdit.data.key);
            }
        };
        ...
        var makeNodeDraggable = function (node) {
            ...
            nodeEl.draggable({
                ...
                helper: function (event) {
                    ...
                    helperEl.removeClass("dynatree-selected");
                    helperEl.removeClass("dynatree-focus");
                    helperEl.removeClass("dynatree-has-children");

                    helperEl.removeClass("dynatree-lazy");
                    helperEl.removeClass("dynatree-lastsib");
                    helperEl.removeClass("dynatree-exp-cdl");
                    helperEl.removeClass("dynatree-ico-c");
        ...
        this.enableUpdate = function (enable) {
            this.treeViewE.dynatree("getTree").enableUpdate(enable);
        };
