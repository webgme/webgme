...
define([], function () {
    ...
    ModelEditorControlDEBUG.prototype._dispatchUpdateEvent = function (idList) {
        var i = idList.length,
            newEvent,
            events = [];
    ...
    ModelEditorControlDEBUG.prototype._dispatchCreateEvent = function (idList) {
        var i = idList.length,
            newEvent,
            events = [];
    ...
    ModelEditorControlDEBUG.prototype._onDebugCreateItems = function (options) {
        ...
        this.logger.debug("ModelEditorControlDEBUG _onDebugCreateItems: " + JSON.stringify(options));
    ...
    ModelEditorControlDEBUG.prototype._generateObjectDescriptorDEBUG = function (id, type) {
        var objDescriptor;
    ...
    ModelEditorControlDEBUG.prototype._getObjectDescriptorDEBUG = function (id) {
        return this._debugObjectDescriptors[id];
    };

    ModelEditorControlDEBUG.prototype._filterItems = function (type, itemIDs) {
    ...
    ModelEditorControlDEBUG.prototype._onDebugUpdateItems = function (type, selectedIDs) {
    ...
    ModelEditorControlDEBUG.prototype._onDebugUpdateItems_MoveItems = function (itemIDs) {
    ...
    ModelEditorControlDEBUG.prototype._onDebugUpdateItems_RenameItems = function (itemIDs) {
        var i = itemIDs.length,
            itemDesc,
            postFix = "_ABC";
    ...
    ModelEditorControlDEBUG.prototype._onDebugUpdateItems_UpdateItemsDecorator = function (itemIDs) {
        var decorator,
            i = itemIDs.length,
            itemDesc;
    ...
    ModelEditorControlDEBUG.prototype._onDebugUpdateItems_UpdateConnections = function (connectionIDs) {
    ...
    ModelEditorControlDEBUG.prototype._onDebugUpdateItems_ReconnectConnections = function (connectionIDs) {
        var i = connectionIDs.length,
            connDesc;
    ...
    ModelEditorControlDEBUG.prototype._onDebugDeleteItems = function (type, selectedIDs) {
        var i,
            filteredIDs = [],
            events = [],
            newEvent,
