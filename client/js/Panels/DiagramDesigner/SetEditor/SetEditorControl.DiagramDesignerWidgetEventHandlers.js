...
define([], function () {
    ...
    var SetEditorControlDiagramDesignerWidgetEventHandlers;

    SetEditorControlDiagramDesignerWidgetEventHandlers = function () {
    };

    SetEditorControlDiagramDesignerWidgetEventHandlers.prototype.attachDiagramDesignerWidgetEventHandlers = function () {
        var self = this;
    ...
    SetEditorControlDiagramDesignerWidgetEventHandlers.prototype._onDesignerItemsMove = function (repositionDesc) {
        var id,
            gmeID,
    ...
    SetEditorControlDiagramDesignerWidgetEventHandlers.prototype._onCreateNewConnection = function (params) {
    ...
    SetEditorControlDiagramDesignerWidgetEventHandlers.prototype._onSelectionDelete = function (idList) {
    ...
    SetEditorControlDiagramDesignerWidgetEventHandlers.prototype._onDesignerItemDoubleClick = function (id/*, event*/) {
    ...
    return SetEditorControlDiagramDesignerWidgetEventHandlers;
});
