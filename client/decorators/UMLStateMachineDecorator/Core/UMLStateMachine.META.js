...
define(['underscore',
	...
	var _isInitial = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Initial); };
	var _isLanguage = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Language); };
	var _isModels = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Models); };
	var _isState = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.State); };
	var _isStateBase = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.StateBase); };
	var _isTransition = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.Transition); };
	var _isUMLStateDiagram = function (objID) { return METAAspectHelper.isMETAType(objID, _metaTypes.UMLStateDiagram); };
