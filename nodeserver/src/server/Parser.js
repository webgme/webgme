...
requirejs(
    [ "./../common/CommonUtil", "sax", "fs", "MongoStorage", "FlatCore", "config", "util", "metabuilder" ],
    function (commonUtil, SAX, FS, Mongo, Core, CONFIG, UTIL, metabuilder) {
        "use strict";
        ...
        var mongo = new Mongo(CONFIG.mongodb.database,CONFIG.mongodb.collection);
