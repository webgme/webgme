define([],function(){
	var DelayCtrl = function(delayablesocket,div){
		...
		/*outdelay*/ 
		div.appendChild(document.createTextNode("delay for outgoing messages (milliseconds)"));
		...
		/*indelay*/ 
		div.appendChild(document.createTextNode("delay for incoming messages (milliseconds)"));
