...
public abstract class FutureBackup<Type> implements Promise<Type>, Runnable {
...
*/
	...
	@Override
	@SuppressWarnings("unchecked")
	public final void requestForwarding(FutureBackup<Type> parent) {
	...
	@Override
	@SuppressWarnings("unchecked")
	public final void requestArgument(short index, FutureBackup<?> parent) {
	...
	protected final void resolve(Promise<Type> promise) {
		...
		if (oldState == STATE_ARGUMENT)
			((FutureBackup<?>) oldObject).argumentResolved(index, promise);
		else if (oldState == STATE_FORWARDING)
			((FutureBackup<Type>) oldObject).resolve(promise);
	...
	public final void reject(Exception error) {
		...
		if (oldState == STATE_ARGUMENT || oldState == STATE_FORWARDING)
			((FutureBackup<?>) oldObject).reject(error);
