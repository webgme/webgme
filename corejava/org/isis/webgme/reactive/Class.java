...
public class Class {
	...
	protected Value[] methods = new Value[0];

	public <Type, Arg> Value<Type> declareMethod(Unary.Function<Type, Arg> function, Value<Arg> arg) {
		assert(!isSealed());
	...
	public <Type, Arg1, Arg2> Value<Type> declareMethod(Binary.Function<Type, Arg1, Arg2> function, Value<Arg1> arg1, Value<Arg2> arg2) {
		assert(!isSealed());
