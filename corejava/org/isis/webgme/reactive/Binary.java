...
public class Binary<Type, Arg1, Arg2> extends Value<Type> {
	...
	public static final Binary.Function<Boolean, Boolean, Boolean> AND = new Binary.Function<Boolean, Boolean, Boolean>() {
	...
	public static final Binary.Function<Boolean, Boolean, Boolean> OR = new Binary.Function<Boolean, Boolean, Boolean>() {
		public final Boolean compute(Boolean arg1, Boolean arg2)
		{
			if( arg1 == null || arg2 == null )
				return null;
	...
	protected final Observer<Arg1> obs1 = new Observer<Arg1>() {
		public final void modified(Object[] object, Arg1 oldValue, Arg1 newValue) {
			Arg2 other = arg2.get(object);
	...
	protected final Observer<Arg2> obs2 = new Observer<Arg2>() {
		public final void modified(Object[] object, Arg2 oldValue, Arg2 newValue) {
			Arg1 other = arg1.get(object);
			notifyObservers(object, func.compute(other, oldValue), func.compute(other, newValue));
		}
	};

	protected Binary(Class klass, Function<Type, Arg1, Arg2> function, Value<Arg1> arg1, Value<Arg2> arg2) {
		super(klass);
